...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().hashtag(DEFAULT_HASHTAG);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().hashtag(UPDATED_HASHTAG);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getHashtag()).isEqualTo(DEFAULT_HASHTAG);
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.hashtag(UPDATED_HASHTAG);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getHashtag()).isEqualTo(UPDATED_HASHTAG);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.hashtag(UPDATED_HASHTAG);
