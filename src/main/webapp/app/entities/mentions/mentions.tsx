...
import { getEntities, reset } from './mentions.reducer';
...
export const Mentions = () => {
  ...
  const totalItems = useAppSelector(state => state.mentions.totalItems);
  const links = useAppSelector(state => state.mentions.links);
  const entity = useAppSelector(state => state.mentions.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={mentionsList ? mentionsList.length : 0}
          next={handleLoadMore}
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/mentions/${mentions.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
