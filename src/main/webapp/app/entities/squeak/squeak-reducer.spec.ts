...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './squeak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SQUEAK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SQUEAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SQUEAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SQUEAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SQUEAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SQUEAK actions', async () => {
      const expectedActions = [
        {
